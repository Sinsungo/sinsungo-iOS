//
//  ShopBasketAddVC.swift
//  sinsungo
//
//  Created by 원동진 on 2023/11/03.
//

import UIKit
import SnapKit
protocol UnitDelegateShopBasketAdd : AnyObject{
    func sendUnit(standard :String)
}
class ShopBasketAddVC: UIViewController {
    private let shopBasketType = "장바구니 재료 추가"
...
extension ShopBasketAddVC : UnitDelegate{
    func sendUnit(standard: String) {
...
import SwiftUI
struct ShopBasketAddVCPreview: PreviewProvider {
    static var previews: some View {
        ShopBasketAddVC().showPreview(.iPhone14Pro)
    }
}
#endif
